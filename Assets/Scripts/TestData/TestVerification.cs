...
public class TestVerification {
    ...
    public TestVerification(int targetIndex, Vector2 targetPosition, Vector2 cursorPosition, Vector2 gazePosition, float? pupilDiameterLeft, float? pupilDiameterRight,
